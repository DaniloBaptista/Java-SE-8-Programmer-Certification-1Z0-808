...
public class main {
    public static void main(String[] args) {
        ...
        new Carro();//substitui a ultima referencia do objeto, então o primeiro c não ta mais acessivel.
        ...
        c = new Carro();//substitui a ultima referencia do objeto
        ...
        Carro c3;//já neste caso embaixo mesmo saindo do loop a variavel c3 ainda vai existir. Ela foi decalrada fora do loop.
        for(int i = 0; i<10; i++){
            c3 = new Carro();
        }
